      ...
      setSlides([
        {
          ...
          description: "Discover a wide variety of mouthwatering dishes crafted with the freshest ingredients.",
        ...
        },
        {
          ...
          description: "Take advantage of our special promotions and combos for great value.",
          image_url: "https://images.unsplash.com/photo-1544025162-d76694265947?q=80&w=1469&auto=format&fit=crop",
          is_active: true,
          created_at: new Date().toISOString(),
          updated_at: new Date().toISOString(),
          type: 'menu',
