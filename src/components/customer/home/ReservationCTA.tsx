    ...
    <section className="container mx-auto px-4 py-16">
      <div className="relative rounded-xl overflow-hidden">
        ...
        <div className="relative z-10 px-8 py-16 text-center">
          ...
          <h2 className="text-4xl font-bold text-white mb-4">Reserve Your Table Today</h2>
          <p className="text-white/90 text-xl mb-8 max-w-3xl mx-auto">
            Experience exceptional dining with our gourmet menu in a cozy atmosphere. 
            Perfect for family gatherings, romantic evenings, or business meetings.
          </p>
          <Button 
            size="lg"
